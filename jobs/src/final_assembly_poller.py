#!/usr/bin/env python3
"""
Final Assembly Job Poller - Checks for trigger blobs and processes them
"""
import os
import sys
import json
...
def main():
    """Poll for final assembly trigger blobs and process them"""
    ...
    trigger_prefix = "triggers/final-assembly-job-scheduled/"
    
    print(f"🔍 Checking for final assembly job triggers in {trigger_prefix}...")
    ...
    try:
        ...
        for blob in blobs:
            try:
                ...
                # Run final assembly job
                print(f"\n🚀 Running final assembly job for story {story_id}...")
